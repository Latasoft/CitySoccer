...
export default function ClasesParticulareFutbol() {
  const classData = {
    title: "Clases Particulares de Fútbol",
    description: "Entrena con profesionales y mejora tu técnica individual",
    includes: [
      "Entrenador profesional certificado",
      "Material de entrenamiento incluido",
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hola! Me interesa información sobre las clases particulares de fútbol. ¿Podrían contarme más detalles sobre precios y disponibilidad?");
