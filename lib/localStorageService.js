...
export const localStorageService = {
  ...
  getPageContent: async (pageKey) => {
    ...
    try {
      ...
      // 2. Si no hay cache, fetch inicial
      if (CONFIG.DEBUG) {
        console.log(`🔄 [LocalStorageService] Cache miss, fetching: ${pageKey}`);
      }
      ...
      return { data: content, error: null, source: 'server' };
  ...
  /**
   * Actualizar campo (invalida cache)
   */
