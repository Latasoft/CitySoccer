...
export const localContentService = {
  ...
  updateField: async (pageKey, fieldKey, fieldValue) => {
    try {
      ...
      // Disparar evento para invalidar caches en todos los contextos/componentes
      if (typeof window !== 'undefined') {
        window.dispatchEvent(new CustomEvent('content-updated', {
          detail: { pageKey, fieldKey, fieldValue }
        }));
        console.log(`🔔 Evento 'content-updated' disparado para: ${pageKey}.${fieldKey}`);
      }
