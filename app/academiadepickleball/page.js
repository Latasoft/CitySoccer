...
export default function AcademiaPickleball() {
  const academyData = {
    ...
    description: "Aprende el deporte que combina tenis, bádminton y ping pong. Ideal para todas las edades y niveles",
    categories: [
      {
        name: "Iniciación (8-12 años)",
        description: "Primeros pasos en el pickleball de forma divertida",
        focus: ["Coordinación básica", "Reglas del juego", "Trabajo en equipo", "Diversión asegurada"]
      },
      {
        name: "Juvenil (13-17 años)", 
        description: "Desarrollo técnico y competitivo",
        focus: ["Técnica de golpes", "Estrategia de juego", "Condición física", "Mentalidad competitiva"]
      },
      {
        name: "Adulto Principiante (18+ años)",
        description: "Perfecto para quienes se inician en el deporte",
        focus: ["Fundamentos básicos", "Técnica de saque", "Posicionamiento", "Reglas oficiales"]
      },
      {
        name: "Adulto Avanzado (18+ años)",
        description: "Para jugadores con experiencia que buscan perfeccionar su juego",
        focus: ["Táctica avanzada", "Golpes especiales", "Juego competitivo", "Preparación para torneos"]
      }
    ],
    benefits: [
      "Instructores certificados en Pickleball",
      "Raquetas y pelotas incluidas",
      "Progresión técnica estructurada",
      "Participación en torneos internos",
      "Clases adaptadas al nivel de cada grupo",
      "Canchas especializadas de pickleball",
      "Ambiente familiar y divertido",
      "Certificados de nivel alcanzado"
    ],
    schedule: [
