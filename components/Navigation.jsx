...
const navItems = [
  ...
  { linkText: "Quienes somos", href: "/quienessomos" },
  {
    linkText: "Servicios",
    subTitulos: [
      { linkText: "Arriendos Futbol 7", href: "/arriendosfutbol7" },
      { linkText: "Arriendos Futbol 9", href: "/arriendosfutbol9" },
      { linkText: "Arriendos Pickeball", href: "/arriendospickeball" },
      {
...
export default function Navigation() {
  ...
  const handleLinkClick = () => {
    ...
    // No cerrar el menú principal al hacer clic en un link
  };
  ...
  return (
    <>
      {/* Navbar expandible */}
      <nav
        className={`fixed top-0 left-0 h-screen bg-[#57AA32] z-50 flex flex-col transition-all ease-in-out duration-[382ms] ${
          menuOpen ? "w-80" : "w-20"
        }`}
      >
            ...
            <>
              ...
              >
                <div className="inline-flex h-6 w-7 relative cursor-pointer transition-all ease-in-out duration-200">
                  ...
                  <div className="mx-auto w-7 h-1 absolute top-2.5 left-0 z-10 transition-all ease-in-out duration-[380ms] bg-[#57AA32]"></div>
                  <div className="block mx-auto w-7 h-1 absolute left-0 z-20 transition-all ease-in-out duration-[380ms] bg-white top-2.5 -rotate-45"></div>
                </div>
              </div>
            </>
      ...
      <div
        className={`transition-all ease-in-out duration-[382ms] ${
