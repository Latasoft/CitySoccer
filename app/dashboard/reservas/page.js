    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-950">
      <header className="bg-gray-800/50 border-b border-gray-700 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-[#ffee00]">Reservas</h1>
            <p className="text-gray-300">Gestión de reservas</p>
          </div>
        ...
        <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700 mb-6">
          <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-end">
            <div className="flex-1">
              <label className="text-sm text-gray-300 mb-1 block">Buscar</label>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead className="bg-gray-800/70">
                <tr>
                  <th className="text-left text-gray-300 text-sm font-semibold px-4 py-3">Fecha</th>
                  <th className="text-left text-gray-300 text-sm font-semibold px-4 py-3">Hora</th>
                  <th className="text-left text-gray-300 text-sm font-semibold px-4 py-3">Cancha</th>
              ...
              <tbody>
                {loading ? (
                  ...
                  filteredBySearch.map((r) => (
                    <tr key={r.id} className="border-t border-gray-700/70">
                      <td className="px-4 py-3 text-gray-200">{formatFecha(r.fecha)}</td>
                      <td className="px-4 py-3 text-gray-200">{r.hora_inicio}</td>
                      <td className="px-4 py-3 text-gray-200 flex items-center gap-2">
                        <MapPin className="w-4 h-4 text-[#ffee00]" />
                        {formatNombreCancha(r.canchas)}
                      </td>
                      <td className="px-4 py-3">
                        <div className="text-gray-100 flex items-center gap-2">
                          <User className="w-4 h-4 text-gray-400" />
                          {r.clientes?.nombre || 'Cliente'}
                        </div>
                        <div className="text-gray-400 text-xs">{r.clientes?.correo}</div>
                      </td>
                      <td className="px-4 py-3">
                        ...
                        <div className="flex justify-end gap-2">
                          {r.estado !== 'confirmada' && (
                            <button
                              ...
                              className="px-3 py-1.5 rounded-lg bg-green-600 hover:bg-green-700 text-white text-sm flex items-center gap-1"
                              title="Confirmar"
                            >
                          ...
                          {r.estado !== 'cancelada' && (
                            <button
                              ...
                              className="px-3 py-1.5 rounded-lg bg-yellow-600 hover:bg-yellow-700 text-white text-sm flex items-center gap-1"
                              title="Cancelar"
                            >
